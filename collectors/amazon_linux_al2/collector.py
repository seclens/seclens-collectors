"""Amazon Linux 2 ALAS RSS collector.

Fetches security bulletins from Amazon Linux 2 ALAS RSS feed and pushes
...
FEED_URL = os.environ.get(
    "ALAS_AL2_FEED_URL", "https://alas.aws.amazon.com/AL2/alas.rss"
)
SOURCE_SLUG = "amazon_linux_al2"
USER_AGENT = "SeclensCollector/2.0 (amazon_linux_al2)"
REQUEST_TIMEOUT = 30
...
class AmazonLinux2Collector:
    """Fetch and normalise Amazon Linux 2 security bulletins."""
...
def normalize(entry: dict) -> dict:
    ...
    labels = ["vendor:aws", "distribution:al2"]
...
def main():
    ...
    collector = AmazonLinux2Collector()
    ...
    for entry in entries:
        try:
            ...
            logger.exception("Failed to normalise Amazon Linux 2 entry: %s", entry, exc_info=exc)

"""Amazon Linux 2023 ALAS RSS collector.

Fetches security bulletins from Amazon Linux 2023 ALAS RSS feed and pushes
...
FEED_URL = os.environ.get(
    "ALAS_AL2023_FEED_URL", "https://alas.aws.amazon.com/AL2023/alas.rss"
)
...
class AmazonLinux2023Collector:
    """Fetch and normalise Amazon Linux 2023 security bulletins."""
...
def normalize(entry: dict) -> dict:
    ...
    labels = ["vendor:aws", "distribution:al2023"]
...
def main():
    ...
    for entry in entries:
        try:
            ...
            logger.exception("Failed to normalise Amazon Linux 2023 entry: %s", entry, exc_info=exc)
